        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <InputTextWithLabel
              ...
              :fieldHasError="
                Boolean(
                  zodFormControl.submitAttempted && formErrors?.emailAddress
                )
              "
              :required="true"
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <InputTextWithLabel
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.username)
              "
              :required="true"
              :styleClassPassthrough="['style-1', 'style-2']"
              theme="primary"
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <InputPasswordWithLabel
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.password)
              "
              :required="true"
              :styleClassPassthrough="['style-1', 'style-2']"
              theme="primary"
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <InputTextareaWithLabel
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.message)
              "
              :required="true"
              :styleClassPassthrough="['style-1', 'style-2']"
            >
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <InputTextAsNumberWithLabel
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.count2)
              "
              :required="true"
              :styleClassPassthrough="['style-1', 'style-2']"
              theme="primary"
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <InputNumberDefault
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.count)
              "
              :required="true"
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <InputRangeDefault
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.score)
              "
              :required="true"
              :styleClassPassthrough="['style-1', 'style-2']"
            ...
            >
              <template #description>
                <p class="label-description">
                  This is a description of what the user is required to do
                </p>
              </template>
              <template #datalist>
        ...
        <FormField v-if="titleData !== null" width="wide" :has-gutter="false">
          <template #default>
            <MultipleRadiobuttons
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.title)
              "
              v-model="state.title"
        ...
        <FormField v-if="citiesData !== null" width="wide" :has-gutter="false">
          <template #default>
            <MultipleCheckboxes
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.cities)
              "
            ...
            >
              <template #description>
                <p class="label-description">
                  This is description: optionsLayout = 'equal-widths'
                </p>
              </template>
            </MultipleCheckboxes>
          </template>
        ...
        >
          <template #default>
            <MultipleCheckboxes
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.countries)
              "
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <SingleCheckbox
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.agreed)
              "
            ...
            >
              <template #description>
                <p class="label-description">
                  You must <strong>agree</strong> to continue
                </p>
              </template>
            </SingleCheckbox>
          </template>
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <SingleCheckbox
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.agree)
              "
              v-model="state.agree"
              size="normal"
              checkbox-style="check"
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <SingleCheckbox
              ...
              :fieldHasError="
                Boolean(zodFormControl.submitAttempted && formErrors?.terms)
              "
              v-model="state.terms"
              size="normal"
              checkbox-style="check"
        ...
        <FormField width="wide" :has-gutter="false">
          <template #default>
            <SingleCheckbox
              ...
              legend="Toggle zodFormControl.submitAttempted"
              :required="true"
              :errorMessage="formErrors?.terms?._errors[0] ?? ''"
              :fieldHasError="false"
              v-model="zodFormControl.submitAttempted"
              size="normal"
              checkbox-style="check"
              checkbox-appearance="with-decorator"
              theme="success"
            >
              <template #labelContent>
                <span class="body-normal"
                  >Manual toggle for zodFormControl.submitAttempted</span
                >
              </template>
            </SingleCheckbox>
          </template>
 ...
 **/
const { data: citiesData } = await useFetch<IFormMultipleOptions>(
  "/api/places/list?category=cities"
);
const { data: countriesData } = await useFetch<IFormMultipleOptions>(
  "/api/places/list?category=countries"
);
const { data: titleData } = await useFetch<IFormMultipleOptions>(
  "/api/utils?category=title"
);
  ...
  z
    .object({
      ...
      username: z
        ...
        .refine(
          (email) => email !== zodFormControl.previousState.username.value,
          {
      ...
      password: z
        ...
        .refine(
          (email) => email !== zodFormControl.previousState.password.value,
          {
      ...
      agreed: z
        .boolean()
        .refine((val) => val === true, { message: "You must tick this box" }),
      agree: z
        .boolean()
        .refine((val) => val === true, { message: "You must tick this box" }),
      terms: z
